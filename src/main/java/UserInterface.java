        ...
        try {
            ...
            while (player) {
                ...
                switch (command) {
                    ...
                    case "inventory","inv","i" -> System.out.println(adventure.getPlayer().showInventory());
                    case "take" -> {
                        boolean succesTake = adventure.getPlayer().takeItem(userChoice);
                        if (succesTake){
                    ...
                    case "drop" -> {
                        boolean succesDrop = adventure.getPlayer().dropItem(userChoice);
                        if (succesDrop){
